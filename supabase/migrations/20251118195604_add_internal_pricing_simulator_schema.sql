/*
  ...
  Creates tables for formula definitions, pricing variables, scenarios,
  competitor pricing, and calculation debug traces.
*/
...
CREATE POLICY "Authenticated users can read formulas"
  ON formula_definitions FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert formulas"
  ON formula_definitions FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can update formulas"
  ON formula_definitions FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Authenticated users can delete formulas"
  ON formula_definitions FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can read variables"
  ON pricing_variables FOR SELECT TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can delete variables"
  ON pricing_variables FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can read scenarios"
  ON pricing_scenarios FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert scenarios"
  ON pricing_scenarios FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can update scenarios"
  ON pricing_scenarios FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Authenticated users can delete scenarios"
  ON pricing_scenarios FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can read competitor pricing"
  ON competitor_pricing FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert competitor pricing"
  ON competitor_pricing FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can update competitor pricing"
  ON competitor_pricing FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "Authenticated users can delete competitor pricing"
  ON competitor_pricing FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can read debug traces"
  ON calculation_debug_traces FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert debug traces"
  ON calculation_debug_traces FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can delete debug traces"
  ON calculation_debug_traces FOR DELETE TO authenticated USING (true);
