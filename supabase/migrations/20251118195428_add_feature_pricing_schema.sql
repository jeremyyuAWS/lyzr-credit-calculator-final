/*
  ...
  This migration adds support for feature-based pricing.
  
  1. New Tables
    - `feature_pricing` - Runtime feature costs
    - `setup_costs` - One-time setup costs
    - `model_handling_fee` - Model hosting fees
...
CREATE POLICY "Public can read feature pricing"
  ON feature_pricing FOR SELECT TO public USING (true);
CREATE POLICY "Public can insert feature pricing"
  ON feature_pricing FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Public can update feature pricing"
  ON feature_pricing FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Public can delete feature pricing"
  ON feature_pricing FOR DELETE TO public USING (true);
...
CREATE POLICY "Public can read setup costs"
  ON setup_costs FOR SELECT TO public USING (true);
CREATE POLICY "Public can insert setup costs"
  ON setup_costs FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Public can update setup costs"
  ON setup_costs FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Public can delete setup costs"
  ON setup_costs FOR DELETE TO public USING (true);
...
CREATE POLICY "Public can read model handling fee"
  ON model_handling_fee FOR SELECT TO public USING (true);
CREATE POLICY "Public can insert model handling fee"
  ON model_handling_fee FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "Public can update model handling fee"
  ON model_handling_fee FOR UPDATE TO public USING (true) WITH CHECK (true);
CREATE POLICY "Public can delete model handling fee"
  ON model_handling_fee FOR DELETE TO public USING (true);
...
INSERT INTO feature_pricing (feature_name, cost_credits, unit, category, description, enabled) VALUES
  ...
  ('Inter-Agent Token', 0.000001, 'per token', 'runtime', 'Agent-to-agent communication token cost', true)
